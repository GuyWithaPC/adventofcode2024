 ...
 */
use std::ops::{Add, AddAssign, Mul, Div, Neg, Sub, SubAssign};
...
impl <I, N> Vec2<I>
where I: NumOps + Copy + Neg<Output = N> + Into<N>, N: NumOps + Copy {
    /**
...
impl <I> Vec2<I>
where I: NumOps + Copy + num_traits::identities::Zero + num_traits::identities::One + Neg<Output = I> {
    pub fn up() -> Self {
...
where I: NumOps + Neg<Output = N> + Copy,
      N: NumOps + Copy {
